...
export default function NewClientPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      console.error(err)
      alert('Failed to save client. Check your Supabase connection.')
      setSaving(false)
    }
  }
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mt-2">{t.newClient}</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6 space-y-5">
        ...
        <Field label={t.clientPortalPassword}>
          ...
          <p className="text-xs text-slate-400 mt-1">Used to give clients access to view their reports.</p>
        </Field>
